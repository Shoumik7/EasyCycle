...
import GreenhouseHeatMap from '../assets/GreenhouseHeatMap.jpeg'
import MapPNG from '../assets/MapPNG.png'
        ...
        <ThemeProvider theme={theme}>
            ...
            <div className='background'>
                ...
                <Box id = "body" sx={{backgroundColor:"#0C6BB9", height: '500', marginTop: -1}}>
                    <Typography variant="h3" align="center" sx={{margin: 4, marginBottom: 15, color: "secondary.contrastText"}}>
                        Research Based Recycling Models
                    </Typography>

                    <Stack direction = "row" justifyContent="center">
                        <Stack direction="column" justifyContent="center" sx={{marginBottom: 0, marginRight: 20}}>
                            <center><img style={{height:'400px', width: "400px", marginLeft: '10px', align:"center"}}src={graph1}/></center>
                            
                            <Typography variant="body2" color="white" sx={{margin: 4, align:'center'}}>                       
                        ...
                        <Stack direction="column" justifyContent="center" sx={{marginBottom: 0}}>
                            <img style={{height:'400x', width: "400px", marginLeft: '10px'}}src={GreenhouseHeatMap}/>
                ...
                <Box id = "body" sx={{backgroundColor:"#0C6BB9", height: '90px'}}>

                </Box>

                <Box id = "body" sx={{backgroundColor:"#0C6BB9", height: 'flex'}}>
                    

                    <Stack direction = "row" justifyContent="center" sx={{marginBottom: 20}}> 
                        <img style={{height:'70%', width: "70%", marginLeft: '10px'}}src={MapPNG}/>
                    </Stack>
